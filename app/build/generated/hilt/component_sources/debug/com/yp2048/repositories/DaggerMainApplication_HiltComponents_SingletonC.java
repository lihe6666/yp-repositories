...
public final class DaggerMainApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MainApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_yp2048_repositories_presentation_main_MainViewModel, MainViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_yp2048_repositories_presentation_main_MainViewModel = "com.yp2048.repositories.presentation.main.MainViewModel";

      @KeepFieldType
      MainViewModel com_yp2048_repositories_presentation_main_MainViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MainApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_yp2048_repositories_presentation_main_MainViewModel, ((Provider) mainViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.yp2048.repositories.presentation.main.MainViewModel 
          return (T) new MainViewModel(singletonCImpl.scanFaceRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends MainApplication_HiltComponents.SingletonC {
    ...
    private Provider<ScanFaceRepository> scanFaceRepositoryProvider;
    ...
    private void initialize() {
      this.scanFaceRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<ScanFaceRepository>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.yp2048.repositories.data.repository.ScanFaceRepository 
          return (T) new ScanFaceRepository(new ScanFaceRemoteDataSource(), new ScanFaceLocalDataSource());
